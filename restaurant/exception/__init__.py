...
class RestaurantException(Exception):
    ...
    # when print(RestaurantException())-> then this is represented by __str__()
    def __str__(self):
        return self.error_message

    # without print if object is called of RestaurantException() -> then this is represented by __repr__()
